...
function ImagePreview({ previewUrl, filename, image, detections = [], faces = [], plates = [], cards = [], showObjects, showFaces, showPlates, showCards, isAnalyzing = false, onLoaded, onError }) {
  if (!previewUrl) {
