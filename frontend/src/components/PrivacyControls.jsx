...
const riskTypes = ['Background', 'Faces', 'License plates', 'Identity documents', 'Sensitive text']
  ...
  return (
    <aside className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6" aria-labelledby="privacy-controls-title">
      <div className="flex items-start gap-3">
        ...
        <div><h3 id="privacy-controls-title" className="font-bold text-slate-950">Privacy controls</h3><p className="mt-1 text-sm leading-6 text-slate-600">Available after AI detection.</p></div>
      </div>
      ...
      <div className="mt-6 flex items-center gap-2 rounded-xl bg-slate-100 px-3 py-3 text-xs font-medium leading-5 text-slate-500"><EyeOffIcon className="h-4 w-4 shrink-0" />Controls unlock when real detections are available.</div>
    </aside>
  )
}
